...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "lv_tick_source.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (edgetxLvglTickGet())    /*Expression evaluating to current system time in ms*/
